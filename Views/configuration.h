...
namespace AC {
    ...
    const static ColorOrder STARTUP_COLOR_ORDER = ColorOrder::RBG;
    const static LEDColorCorrection STARTUP_COLOR_CORRECTION = LEDColorCorrection::TypicalSMD5050;

    const static int CAPTURE_FPS = 30;

    const static int CONTROLLER_FPS = 30;
    ...
    const static int PREVIEW_FPS = 30;
}
